...
kumokagi implements a pydantic-settings **custom source**. Only keys listed in `config.keys` are fetched from the backend — other fields use env vars, defaults, or other sources.
