---
title: Go — viper integration
weight: 6
---

# Go — viper integration

kumokagi acts as a **source** in viper's config resolution chain. Secrets loaded via kumokagi take highest precedence (`v.Set()`), above env vars and config files.
