...
The domain vocabulary used throughout these docs and the codebase.
...
A kumokagi implementation of the secrets backend interface for a specific Secrets Backend. Each Provider translates the common interface to backend-specific API calls.
